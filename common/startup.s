...
// BSET takes a literal bit position, not a mask, so define the
...
start:
      ...
      // M-register defaults the cc21k C calling convention
      ...
      // set below). cc21k expects the stack DAG to be a circular
      ...
      // Stack pointer (I7) and frame pointer (I6). cc21k uses
      ...
      // the cc21k stack DAG circular wrap operates on the literal
