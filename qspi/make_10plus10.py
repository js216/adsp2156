...
random.seed(999);  s999 = bytes(random.getrandbits(8) for _ in range(40))

combined = s999 + s123      # 80 B, 20 words
...
buf += q.uart_tx(b"h 80\r");  buf += q.delay_us(500000)

with open("ten_plus_ten.qspi", "wb") as f: f.write(buf)
print("wrote ten_plus_ten.qspi")
