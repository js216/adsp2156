...
random.seed(999); s999 = bytes(random.getrandbits(8) for _ in range(4))   # 1 word
random.seed(123); s123 = bytes(random.getrandbits(8) for _ in range(40))  # 10 words
...
with open("one_plus_ten.qspi", "wb") as f: f.write(buf)
print("wrote one_plus_ten.qspi")
